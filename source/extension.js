...
async function patchCursorGetMachineId() {
    try {
        ...
        vscode.window.showInformationMessage('github: https://github.com/shengdingbox/cursor-machine-id');
    } catch (error) {
...
function activate(context) {
    let disposable = vscode.commands.registerCommand('cursor-machine-id.patch', async () => {
        try {
